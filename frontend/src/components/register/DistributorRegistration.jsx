...
const DistributorRegistration = () => {
  ...
  const handleRegisterDistributor = async () => {
    ...
    try {
      ...
      console.error(error);
      setError('Error registering distributor. Make sure the contract is deployed.');
    }
  };
  ...
  return (
    <div className="flex mt-30  justify-center flex-col items-center relative">
      ...
      <h2 className='text-3xl font-semibold'>Register as a Distributor</h2>
    <div className='flex flex-col items-center mt-5 gap-4 py-4 px-4'>
      ...
      <button
        className='bg-black text-white px-4 text-xl cursor-pointer rounded-xl mt-3 py-2'
        onClick={handleRegisterDistributor}
      >
