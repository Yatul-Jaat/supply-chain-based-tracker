...
const DistributionCrops = () => {
  ...
  return (
    ...
    <div className=' px-4 py-2 rounded-xl text-3xl uppercase font-semibold text-center'>Crops in Distributing Stage</div>
    {crops.length>0?(
    ...
    {crops.map((crop,index)=>(
      ...
      <li><span className='text-xl font-semibold'>Stage: </span>Distributing</li>
    </ul>
    ))}</div>):(
      <p className='text-2xl font-semibold text-center'>No crops in the Distributing stage.</p>
    )}
